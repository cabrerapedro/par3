...
// Section = { href, label key, icon, group }. `sidebarOnly` sections show on the
// desktop sidebar (office mode) but not the mobile tab bar (class mode).
// The desktop sidebar groups sections; the mobile tab bar stays flat.
type NavGroup = 'clase' | 'gestion'
const NAV_GROUPS: NavGroup[] = ['clase', 'gestion']

const SECTIONS: { key: string; href: string; group: NavGroup; sidebarOnly?: boolean; Icon: (p: IconProps) => React.ReactElement }[] = [
  {
    key: 'today', href: '/instructor/today', group: 'clase',
    Icon: ({ className }) => (
  ...
  {
    key: 'students', href: '/instructor/dashboard', group: 'clase',
    Icon: ({ className }) => (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
  ...
  {
    key: 'library', href: '/instructor/library', group: 'clase', sidebarOnly: true,
    Icon: ({ className }) => (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
  ...
  {
    key: 'messages', href: '/instructor/messages', group: 'gestion',
    Icon: ({ className }) => (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
  ...
  {
    key: 'campaigns', href: '/instructor/campaigns', group: 'gestion',
    Icon: ({ className }) => (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
  ...
  {
    key: 'stats', href: '/instructor/stats', group: 'gestion',
    Icon: ({ className }) => (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
