...
export function GET() {
  const base = siteUrl()
  const body = `# Forat Golf

> Forat Golf es un copiloto de práctica de golf para instructores profesionales y sus alumnos. El instructor graba y anota la técnica correcta del alumno; el alumno la practica solo entre clases con esa referencia en el teléfono y recibe feedback en tiempo real, una indicación a la vez.
...
- Principio irrenunciable: el instructor es siempre la autoridad. Forat complementa su método, no lo reemplaza.
